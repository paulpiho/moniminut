          ...
          var GreenAudioPlayer =
            ...
            (function() {
              function GreenAudioPlayer(player, options) {
                ...
                this.speaker = this.audioPlayer.querySelector(
                  ".volume__speaker"
                );
                ...
                [
                  {
                    ...
                    value: function initEvents() {
                      ...
                      var self = this;
                      self.audioPlayer.addEventListener("mousedown", function(
                        event
                      ) {
                      ...
                      this.player.addEventListener(
                        "loadedmetadata",
                        function() {
                          _this.totalTime.textContent = GreenAudioPlayer.formatTime(
                  ...
                  },
                  {
                    ...
                    value: function updateVolume() {
                      this.volumeProgress.style.width = "".concat(
                    ...
                    value: function getCoefficient(event) {
                      ...
                      if (slider.dataset.direction === "horizontal") {
                        ...
                        var clientX = touch
                          ...
                          : event.clientX;
                        var offsetX =
                          clientX - sliderPositionAndDimensions.left;
                  ...
                  },
                  {
                    ...
                    value: function changeVolume(event) {
                      if (this.inRange(event)) {
                        this.player.volume =
                          Math.round(this.getCoefficient(event) * 10) / 10;
                      }
                    }
                  },
                  {
