class GreenAudioPlayer {
  constructor(player, options) {
    this.audioPlayer =
      typeof player === "string" ? document.querySelector(player) : player;
    const opts = options || {};
  ...
  initEvents() {
    ...
    this.player.addEventListener("loadedmetadata", () => {
      this.totalTime.textContent = GreenAudioPlayer.formatTime(
  ...
  static pausePlayer(player) {
    const playPauseButton = player.parentElement.querySelector(
